...
# MAGIC     INSERT (target.tpep_pickup_datetime, target.tpep_dropoff_datetime, target.trip_distance, target.fare_amount, target.pickup_zip, target.dropoff_zip) VALUES (source.tpep_pickup_datetime, source.tpep_dropoff_datetime, source.trip_distance, source.fare_amount, source.pickup_zip, source.dropoff_zip)
